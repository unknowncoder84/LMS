-- =====================================================
-- SAFE DYNAMIC SETUP FOR KATNESHWARKAR LEGAL DASHBOARD
...
-- =====================================================
-- 4. LIBRARY_LOCATIONS TABLE (create first - referenced by library_items)
-- =====================================================
...
-- =====================================================
-- 5. STORAGE_LOCATIONS TABLE (create first - referenced by storage_items)
-- =====================================================
...
-- =====================================================
-- 6. LIBRARY_ITEMS TABLE - For Library Management
-- =====================================================
...
-- Drop existing policies first, then recreate
DROP POLICY IF EXISTS "Anyone can view library_items" ON public.library_items;
DROP POLICY IF EXISTS "Authenticated users can insert library_items" ON public.library_items;
DROP POLICY IF EXISTS "Authenticated users can update library_items" ON public.library_items;
DROP POLICY IF EXISTS "Authenticated users can delete library_items" ON public.library_items;
...
-- =====================================================
-- 7. STORAGE_ITEMS TABLE - For Storage Management
-- =====================================================
...
-- Drop existing policies first, then recreate
DROP POLICY IF EXISTS "Anyone can view storage_items" ON public.storage_items;
DROP POLICY IF EXISTS "Authenticated users can insert storage_items" ON public.storage_items;
DROP POLICY IF EXISTS "Authenticated users can update storage_items" ON public.storage_items;
DROP POLICY IF EXISTS "Authenticated users can delete storage_items" ON public.storage_items;
...
-- =====================================================
-- 10. ENABLE REALTIME FOR NEW TABLES (ignore errors if already added)
-- =====================================================
DO $$
BEGIN
  BEGIN
